...
const GradientBackground = () => (
  <>
    ...
    <div className="absolute top-[-120px] right-[-200px] w-80 h-80 bg-gradient-to-tr from-blue-400 via-indigo-500 to-purple-600 rounded-full blur-3xl opacity-20 animate-spin-slow z-0" />
